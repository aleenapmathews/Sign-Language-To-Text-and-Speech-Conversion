...
**Watch the complete demonstration of our Sign Language to Text and Speech Conversion system:**

📁 **Local Demo Video Path:**
```
C:\Users\sreya\OneDrive\Desktop\S8\sign to speech final_rec.mp4
```
